...
{
	struct drgn_program *prog = &self->trace->prog->prog;
	struct drgn_object func;
	DrgnObject *ret;
	struct drgn_error *err;
	PyObject *parameters_obj;
	struct drgn_frame_symbol *parameters;
...
{
	struct drgn_frame_symbol *variables;
	struct drgn_error *err;
...
static PyGetSetDef StackFrame_getset[] = {
	...
	{"variables", (getter)StackFrame_variables, NULL, "blah" },
	{"parameters", (getter)StackFrame_parameters, NULL, "blah" },
	{},
};
